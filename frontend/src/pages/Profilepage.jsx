...
function Profilepage() {
  return (
    <div className="border-b-2 flex flex-wrap  items-center  justify-center p-2 ">
      ...
      <div className="border-b-2  bg-gray-100 flex flex-col justify-center flex-wrap w-11/12 rounded-lg shadow-md">
        <UserInformations />
        <PasswordChange />
        <DeleteProfile />
      </div>

  ...
  return (
    <div className="bg-gray-100 m-10 p-10 flex justify-around flex-col rounded-md">
      ...
      <div className="flex flex-row ">
        ...
        {/* A MAPPER SUR DATASET NIVEAU ETUDES */}
        <div className="flex flex-col ml-30">
          ...
          <div className="inline-block relative w-96 m-5 bg-white border border-black rounded-md">
            <select className="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
              <option>Bac (CAP, BEP)</option>
              <option>Bac +2 (BTS, DUT, DEUST)</option>
              <option>Bac +3 (License, BUT)</option>
              <option>Bac +4 (Master 1, Maitrise)</option>
              <option>Bac +5 (Master 2, DEA, DESS, Diplôme ingénieur)</option>

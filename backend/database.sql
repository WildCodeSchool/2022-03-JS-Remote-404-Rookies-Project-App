...
-- -----------------------------------------------------
-- Schema rookies_app_db
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema rookies_app_db
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `rookies_app_db` DEFAULT CHARACTER SET utf8 ;
USE `rookies_app_db` ;
...
CREATE INDEX `fk_companies_sectors1_idx` ON `rookies_app_db`.`companies` (`sectors_id` ASC) VISIBLE;

CREATE INDEX `fk_companies_images1_idx` ON `rookies_app_db`.`companies` (`images_id` ASC) VISIBLE;

CREATE INDEX `fk_companies_workforces1_idx` ON `rookies_app_db`.`companies` (`workforces_id` ASC) VISIBLE;

CREATE UNIQUE INDEX `images_id_UNIQUE` ON `rookies_app_db`.`companies` (`images_id` ASC) VISIBLE;

CREATE UNIQUE INDEX `sectors_id_UNIQUE` ON `rookies_app_db`.`companies` (`sectors_id` ASC) VISIBLE;

CREATE UNIQUE INDEX `company_project_id_UNIQUE` ON `rookies_app_db`.`companies` (`company_project_id` ASC) VISIBLE;

CREATE UNIQUE INDEX `workforces_id_UNIQUE` ON `rookies_app_db`.`companies` (`workforces_id` ASC) VISIBLE;
...
CREATE INDEX `fk_schools_images1_idx` ON `rookies_app_db`.`schools` (`images_id` ASC) VISIBLE;
...
CREATE UNIQUE INDEX `email_UNIQUE` ON `rookies_app_db`.`users` (`email` ASC) VISIBLE;
...
CREATE INDEX `fk_User_Entity_idx` ON `rookies_app_db`.`profiles` (`entity_category_id` ASC) VISIBLE;

CREATE INDEX `fk_user_company1_idx` ON `rookies_app_db`.`profiles` (`company_id` ASC) VISIBLE;

CREATE INDEX `fk_user_school1_idx` ON `rookies_app_db`.`profiles` (`school_id` ASC) VISIBLE;

CREATE INDEX `fk_profile_user1_idx` ON `rookies_app_db`.`profiles` (`user_id` ASC) VISIBLE;

CREATE INDEX `fk_profile_images1_idx` ON `rookies_app_db`.`profiles` (`images_id` ASC) VISIBLE;

CREATE UNIQUE INDEX `images_id_UNIQUE` ON `rookies_app_db`.`profiles` (`images_id` ASC) VISIBLE;

CREATE UNIQUE INDEX `school_id_UNIQUE` ON `rookies_app_db`.`profiles` (`school_id` ASC) VISIBLE;
...
CREATE INDEX `fk_school_project_student_level1_idx` ON `rookies_app_db`.`school_ressources` (`student_level_id` ASC) VISIBLE;

CREATE INDEX `fk_school_projects_users1_idx` ON `rookies_app_db`.`school_ressources` (`profiles_id` ASC) VISIBLE;

CREATE INDEX `fk_school_projects_workforces1_idx` ON `rookies_app_db`.`school_ressources` (`workforces_id` ASC) VISIBLE;

CREATE INDEX `fk_school_projects_sectors1_idx` ON `rookies_app_db`.`school_ressources` (`sectors_id` ASC) VISIBLE;

CREATE INDEX `fk_school_ressources_schools1_idx` ON `rookies_app_db`.`school_ressources` (`schools_id` ASC) VISIBLE;
...
CREATE INDEX `fk_company_project_project_types1_idx` ON `rookies_app_db`.`company_project` (`project_types_id` ASC) VISIBLE;

CREATE INDEX `fk_company_project_users1_idx` ON `rookies_app_db`.`company_project` (`profiles_id` ASC) VISIBLE;

CREATE INDEX `fk_company_project_stages1_idx` ON `rookies_app_db`.`company_project` (`stages_id` ASC) VISIBLE;

CREATE INDEX `fk_company_project_school_ressources1_idx` ON `rookies_app_db`.`company_project` (`school_ressources_id` ASC) VISIBLE;

CREATE INDEX `fk_company_project_companies1_idx` ON `rookies_app_db`.`company_project` (`companies_id` ASC) VISIBLE;
...
CREATE INDEX `fk_school_has_teaching_field_teaching_field1_idx` ON `rookies_app_db`.`school_has_teaching_field` (`teaching_field_id` ASC) VISIBLE;

CREATE INDEX `fk_school_has_teaching_field_school1_idx` ON `rookies_app_db`.`school_has_teaching_field` (`school_id` ASC) VISIBLE;
...
CREATE INDEX `fk_school_project_has_teaching_field_teaching_field1_idx` ON `rookies_app_db`.`school_project_has_teaching_field` (`teaching_field_id` ASC) VISIBLE;

CREATE INDEX `fk_school_project_has_teaching_field_school_project1_idx` ON `rookies_app_db`.`school_project_has_teaching_field` (`school_project_id` ASC) VISIBLE;
...
CREATE INDEX `fk_school_projects_has_languages_languages1_idx` ON `rookies_app_db`.`school_projects_has_languages` (`languages_id` ASC) VISIBLE;

CREATE INDEX `fk_school_projects_has_languages_school_projects1_idx` ON `rookies_app_db`.`school_projects_has_languages` (`school_projects_id` ASC) VISIBLE;

INSERT INTO `school_projects_has_languages` (`school_project_id`, `languages_id`) VALUES
('1', 1),
('1', 2);
-- -----------------------------------------------------
...
CREATE INDEX `fk_company_project_has_teaching_fields_teaching_fields1_idx` ON `rookies_app_db`.`company_project_has_teaching_fields` (`teaching_fields_id` ASC) VISIBLE;

CREATE INDEX `fk_company_project_has_teaching_fields_company_project1_idx` ON `rookies_app_db`.`company_project_has_teaching_fields` (`company_project_id` ASC) VISIBLE;

INSERT INTO `school_project_has_teaching_field` (`company_project_id`, `teaching_field_id`) VALUES
('1', 1);
